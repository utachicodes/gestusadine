...
const translations = {
  en: {
    ...
    // Shop
    'shop.islamic': 'Islamic',
    'shop.waitlist_title': 'Exclusive Merch',
    'shop.waitlist_subtitle': 'Limited edition drops.',
    'shop.waitlist_exclusive': 'Exclusive',
    'shop.waitlist_drop_hint': 'Drops soon',
    'shop.preview': 'Preview',
    'shop.preorder': 'Pre-order',
    'shop.waitlist_description': 'High quality Islamic merchandise.',
    'shop.waitlist_price_hint': '{price} {currency}',
    'shop.redirecting_naboo': 'Redirecting to NabooPay...',
    'shop.buy_with_naboo': 'Buy with NabooPay',
    'shop.waitlist_email_placeholder': 'Enter your email',
    'shop.waitlist_cta': 'Join Waitlist',
    'shop.waitlist_joined': 'Joined!',
    'shop.waitlist_joined_short': 'Joined',
    // Admin
  ...
  fr: {
    ...
    // Shop
    'shop.islamic': 'Islamique',
    'shop.waitlist_title': 'Merch Exclusif',
    'shop.waitlist_subtitle': 'Collections limitées.',
    'shop.waitlist_exclusive': 'Exclusif',
    'shop.waitlist_drop_hint': 'Bientôt disponible',
    'shop.preview': 'Aperçu',
    'shop.preorder': 'Précommande',
    'shop.waitlist_description': 'Produits islamiques de haute qualité.',
    'shop.waitlist_price_hint': '{price} {currency}',
    'shop.redirecting_naboo': 'Redirection vers NabooPay...',
    'shop.buy_with_naboo': 'Acheter avec NabooPay',
    'shop.waitlist_email_placeholder': 'Entrez votre email',
    'shop.waitlist_cta': 'Rejoindre la liste',
    'shop.waitlist_joined': 'Rejoint !',
    'shop.waitlist_joined_short': 'Rejoint',
    // Admin
  ...
  wo: {
    ...
    // Shop
    'shop.islamic': 'Takkom',
    'shop.waitlist_title': 'Merch bu Exclusif',
    'shop.waitlist_subtitle': 'Lu ñu yée.',
    'shop.waitlist_exclusive': 'Exclusif',
    'shop.waitlist_drop_hint': 'Dina ñëw léegi',
    'shop.preview': 'Gis',
    'shop.preorder': 'Jënd',
    'shop.waitlist_description': 'Lu baax ci Islam.',
    'shop.waitlist_price_hint': '{price} {currency}',
    'shop.redirecting_naboo': 'Tékkale ci NabooPay...',
    'shop.buy_with_naboo': 'Jënd ak NabooPay',
    'shop.waitlist_email_placeholder': 'Dugal sa email',
    'shop.waitlist_cta': 'Dugg ci list bi',
    'shop.waitlist_joined': 'Dugg na!',
    'shop.waitlist_joined_short': 'Dugg',
    // Admin
