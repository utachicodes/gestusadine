...
const Language: React.FC = () => {
  ...
  const madhabs: { value: Madhab; label: string; region: string }[] = [
    { value: "hanafi", label: "Hanafi", region: "T√ºrkiye, Pakistan, India, Central Asia" },
  ...
  React.useEffect(() => {
    ...
    const savedMadhab = localStorage.getItem('GÎstuSaDine-madhab') as Madhab;
  ...
  const handleMadhabChange = (newMadhab: Madhab) => {
    setMadhab(newMadhab);
    localStorage.setItem('GÎstuSaDine-madhab', newMadhab);
  };
      ...
      <section className="container py-10 md:py-16 space-y-10">
        <header>
          <div>
            ...
            <p className="mt-2 text-muted-foreground max-w-xl">
              Customize your experience, language, and theme. GÎstuSaDine will tailor everything to your choices.
            </p>
          </div>
        </header>
        ...
        <div className="islamic-card p-6 flex items-start gap-4 bg-muted/30 border rounded-xl">
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            ...
            <p>
              When you ask a question in Guided Fatwa or explore Daily Islam, GÎstuSaDine will prioritize references, rulings, and explanations from your selected madhab and present them in your chosen language.
            </p>
          </div>
        </div>
      </section>
