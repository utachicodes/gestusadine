...
> **Note:** The Council AI is temporarily offline while qualified scholars verify its responses for Islamic authenticity. The multi-agent routing architecture is in place and will be activated once verification is complete.
...
| Feature | Description |
|---------|-------------|
| **The Council** | Islamic Q&A with multi-agent intent routing, hierarchy of evidence (Quran → Hadith → scholarly consensus), four-madhhab respect, citation verification, and a strict "I don't know" rule *(currently under scholarly review)* |
